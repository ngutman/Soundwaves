...
void bandsAnimation(float bands[], CRGB leds[]) {
  ...
  leds[NUM_LEDS_PER_STRIP] = CHSV(getHue(43), 150, getValue(255*bands[1]));
  leds[NUM_LEDS_PER_STRIP*2] = CHSV(getHue(170), 150, getValue(255*(bands[3]+bands[2])));
  leds[NUM_LEDS_PER_STRIP*3] = CHSV(getHue(213), 150, getValue(255*(bands[4]+bands[5])));
