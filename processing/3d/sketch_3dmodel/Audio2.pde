...
class Audio2 {
  ...
  void draw(color[][] pixelLeds, float[] freqValues, float[] deltas, float[] averages, float[] bands) {
    ...
    pixelLeds[2][0] = color(150, 150, 255*bands[2]*2);
    pixelLeds[3][0] = color(100, 150, 255*bands[3]*2);
    pixelLeds[4][0] = color(250, 150, 255*bands[4]*2);
    pixelLeds[5][0] = color(300, 150, 255*bands[5]*2);
    //pixelLeds[2][0] = color1;
    //pixelLeds[3][0] = color1;
    //println(bass);
